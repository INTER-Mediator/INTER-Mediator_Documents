...
}obj={id:pages[i].id,parent:pages[i].parent,path:pages[i].path,title:pages[i].title,breadcrumb:pages[i].breadcrumb,body:doc.querySelector(".container article").innerHTML.replace(/(<([^>]+)>)/ig,"")};
